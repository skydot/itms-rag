...
TEMPLATES = [
    ...
    },
    {
        ...
        "example_questions": ["Rooms in Geetanjali?", "How many rooms in Chetak hostel?", "How many rooms in each?", "Rooms per building"],
        "required_params": [],
    ...
    {
        "id": "HOSTEL_AVAILABLE_ROOMS_COUNT",
        "module": "hostel",
        "description": "Count of available rooms",
        "example_questions": ["Available rooms count?", "How many rooms are available?"],
        "required_params": [],
        "optional_params": ["office_id"],
        "allowed_roles": ["principal", "admin", "staff"],
        "result_type": "count",
    ...
    {
        "id": "HOSTEL_OCCUPIED_BEDS",
        "module": "hostel",
        "description": "Count of occupied beds",
        "example_questions": ["How many beds are occupied?", "Occupied beds count?"],
        "required_params": [],
        "optional_params": ["office_id"],
        "allowed_roles": ["principal", "admin", "staff"],
        "result_type": "count",
    ...
    {
        "id": "HOSTEL_AVAILABLE_BEDS",
        "module": "hostel",
        "description": "Count of available beds",
        "example_questions": ["How many beds are available?", "Available beds count?", "Vacant beds total"],
        "required_params": [],
        "optional_params": ["office_id"],
        "allowed_roles": ["principal", "admin", "staff"],
        "result_type": "count",
