...
Tables:
- vehicle_masters: id, user_id, course_id, role_id, name, mobile, ct_id, v_status_id, vehicle_id, from_place, to_place, adult, child, two_way, from_date, to_date, kilometer, train_no, booking_for, type_of_booking, travel_by, reason, pnr_no, driver_id, driver_mobile, v_status, pikup_date, remark_log, status, created_at, updated_at
